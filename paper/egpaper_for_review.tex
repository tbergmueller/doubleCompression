...
% Table is not necessary, since clear. If we have not enough space (which I presume), remove this table
\begin{table}[ht]
...
Later, the average of this subjective scores of three different people % TODO: Point out that these people are the authors of the paper, hence experts
