...
%%%%%%%%% ABSTRACT
\begin{abstract}
	Today, iris biometrics data is usually stored in raw image form. In large scale data bases, e.g.  
	the Aadhaar project, the need for efficient storage, i.e. lossy compression, emerges. Operating with compressed data impacts
