...
\subsubsection{Relative vs. Absolute Segmentation Error Rate}

The SRCC between the relative and absolute segmentation error rates confirms that both metrics show in general the same trend as it can be seen in Table \ref{tab:corrMSER}.
