...
\begin{enumerate}
	\item For \emph{jpg} :
		 ...
		 For $cr_t>15 $ single compressed images were of higher quality compared to re-compressed and
	...
	\item For \emph{jk2}:
        ...
        For $15\leq{cr_t}\leq{40}$ single compressed images were of the lowest quality compared to re-compressed data for MSSIM and VSNR. The latter followed the trend of the higher the $q_p$ the better the quality of the image fig.4		 
