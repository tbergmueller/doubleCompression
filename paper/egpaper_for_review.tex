...
\begin{itemize}
 ...
 \item there is a difference for small compression ratios, i.e. $cr_t < 20$, and large compression ratios, i.e. $cr_t > 50$. However, there is no trend in segmentation accuracy observeable, when investigating the difference between the single- or the reompressed images and% TODO rephrase
...
Later, the average of this subjective scores of three different people were then used to determine the distance metric with the smallest distance to the MOS. By the experiment with the one-hundred randomly chosen graphs, dynamic time warping (DTW) resulted in the smallest distance. 
