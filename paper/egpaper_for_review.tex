...
So far only the impact on iris segmentation has been considered. Recompression artifacts potentially influence other parts of an iris recognition system as well, e.g. iris code generation. This is topic to further research.           
